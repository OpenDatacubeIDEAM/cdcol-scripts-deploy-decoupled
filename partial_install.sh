...
conda install -c conda-forge --no-deps jupyter matplotlib scipy psycopg2 gdal libgdal hdf5 rasterio netcdf4 libnetcdf pandas shapely ipywidgets scipy
conda install -c conda-forge libiconv poppler
